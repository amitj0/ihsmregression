...
public class IHSM_ClassSchedulingInfoOnlinePRATest extends BaseClass {

	private Map<String, String> stepStatus = new LinkedHashMap<>();
	private SoftAssert soft = new SoftAssert();

	@Test(enabled = true, groups = "Regression", priority = 0, description = "Verify Class Scheduling (Online) PRA Test", dataProvider = "ClassScheduling", dataProviderClass = ClassSchedulingDataProvider.class)
	public void verifyClassSchedulingLEC(ClassSchedulingData data) throws Exception {
		...
		try {
			...
			String actualMsg = classInfo.getLastSuccessMsg();
