...
public class IHSM_ClassSchedulingInformationTest extends BaseClass {
	...
	@Test(enabled = false, priority = 0, description = "Verify Class Scheduling (Offline) LEC Test", dataProvider = "ClassScheduling3", dataProviderClass = ClassSchedulingDataProvider.class)
