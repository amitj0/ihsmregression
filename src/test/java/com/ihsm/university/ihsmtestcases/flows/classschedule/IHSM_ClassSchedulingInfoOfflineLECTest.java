...
public class IHSM_ClassSchedulingInfoOfflineLECTest extends BaseClass {

	private Map<String, String> stepStatus = new LinkedHashMap<>();
	private SoftAssert soft = new SoftAssert();

	@Test(enabled = true, groups = "Regression", priority = 1, description = "Verify Class Scheduling (Offline) LEC Test", dataProvider = "ClassScheduling3", dataProviderClass = ClassSchedulingDataProvider.class)
