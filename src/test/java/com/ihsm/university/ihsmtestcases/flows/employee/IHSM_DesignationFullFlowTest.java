...
public class IHSM_DesignationFullFlowTest extends BaseClass {
	...
	public void employeeRightsInformation() {
		...
		try {
			...
			empRights = new Designation_EmploymentRights(getDriver());
			empPosition = empRights.fillEmploymentRightsForm("Part Time", "0.25", "Transfer",
					TestDataGenerator.randomNumber(5), "01012026", "01012027", "Department of Humanitarian Disciplines",
					"Faculty",
	...
	@Test(groups = "Regression", dependsOnMethods = "employeeRightsInformation",  description = "Verify Employee Position Information Test")
