...
public class IHSMErrorLogCountAPI {

    @Test
    public void captureCurrentDateErrorLogCount() {

        RestAssured.baseURI = "https://api.universityism.com";
